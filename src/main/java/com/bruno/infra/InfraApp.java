package com.bruno.infra;

import com.bruno.infra.config.ApplicationProperties;
import com.bruno.infra.config.DefaultProfileUtil;
...
public class InfraApp {
    ...
    private static final Logger log = LoggerFactory.getLogger(InfraApp.class);

    private final Environment env;

    public InfraApp(Environment env) {
        this.env = env;
    }
    ...
    public static void main(String[] args) throws UnknownHostException {
        SpringApplication app = new SpringApplication(InfraApp.class);
